...
public:
	...
	void visualizePage3(ID3D11Device* g_pd3dDevice, ImVec2 windowSize, std::string file_path_str, std::vector<texture>* textureList);
...
private:
	static void showSpirit(std::string file_path, Spirit spirit, ImVec2 window_size, ID3D11Device* g_pd3dDevice, texture* texture);
